#!/usr/bin/env python3
"""
Тестирование исправленного форматирования цитат
"""
...
async def test_quote_formatting():
    """Тестирует исправленное форматирование цитат"""
    
    print("🔧 Тестирование исправленного форматирования цитат...")
    ...
    # Создаем тестовые цитаты с исправленным форматированием
    test_quotes = []
    ...
    print(f"   ✅ Цитаты должны отображаться с визуальным оформлением:")
    print(f"      ┌─ 💬")
...
if __name__ == "__main__":
    asyncio.run(test_quote_formatting())
