...
def create_immediate_test_posts():
    ...
    try:
        ...
        if success_count > 0:
            ...
            print(f"🆔 ID канала: -1003024242503")
            return True
        else:
...
def verify_channel_id():
    ...
    try:
        ...
        print(f"🎯 Ожидаемый ID: -1003024242503")
        
        if TELEGRAM_CHANNEL_ID == "-1003024242503":
...
def main():
    ...
    if not channel_ok:
        ...
        print(f"🔧 Обновите TELEGRAM_CHANNEL_ID в Railway на -1003024242503")
