#!/usr/bin/env python3
"""
Тестирование исправленного форматирования цитат с <blockquote>
"""
...
async def test_quote_blockquote():
    """Тестирует исправленное форматирование цитат с <blockquote>"""
    
    print("🔧 Тестирование исправленного форматирования цитат с <blockquote>...")
    ...
    # Создаем тестовые цитаты с <blockquote> форматированием
    test_quotes = []
    ...
    print(f"   ✅ Цитаты должны отображаться с <blockquote> форматированием:")
    print(f"      <blockquote>Текст цитаты</blockquote>")
...
if __name__ == "__main__":
    asyncio.run(test_quote_blockquote())
